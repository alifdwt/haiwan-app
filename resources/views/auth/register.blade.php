...
@section('auth-content')
    <div>
        <div class="flex gap-2 mb-5">
            <button type="button" onclick="window.location.href='/register-doctor'"
                class="w-full cursor-pointer rounded-lg border border-warning bg-warning p-4 font-medium text-white transition hover:bg-opacity-90">I
                am a doctor</button>
            <button type="button"
                class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90">I
                am a user</button>
        </div>
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <!-- Phone -->
            <div class="mb-4">
                <label for="phone" class="mb-2.5 block font-medium text-black dark:text-white">Phone</label>
                <div class="relative">
            ...
            <div class="mb-4 columns-3">
                <!-- State -->
                <div>
                    <label for="state" class="mb-2.5 font-medium text-black dark:text-white">State</label>
                ...
                <!-- City -->
                <div>
                    <label for="city" class="mb-2.5 font-medium text-black dark:text-white">City</label>
                ...
                <!-- Zip -->
                <div>
                    <label for="zip" class="mb-2.5 font-medium text-black dark:text-white">Zip</label>
            ...
            <div class="mb-4 columns-2">
                ...
                <div>
                    <div>
                        <label for="opening_hours_from" class="mb-2.5 font-medium text-black dark:text-white">Opening
                            hours
                            from</label>
                        <input type="time" id="opening_hours_from" name="opening_hours_from"
                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        <x-input-error :messages="$errors->get('opening_hours_from')" class="mt-2" />
                    </div>
                    <div>
                        <label for="opening_hours_to" class="mb-2.5 font-medium text-black dark:text-white">Opening hours
                            to</label>
                        <input type="time" id="opening_hours_to" name="opening_hours_to"
                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        <x-input-error :messages="$errors->get('opening_hours_to')" class="mt-2" />
                    </div>
                </div>
                <!-- Opening days -->
                <div>
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <x-input-error :messages="$errors->get('opening_days')" class="mt-2" />
                    </div>
                </div>
            </div>
            ...
            <!-- Optional Images -->
            <div class="mb-4">
                <h4 class="mb-2.5 font-medium text-black dark:text-white">Optional Images</h4>
                <div class="mb-4 columns-3">
                    <!-- Image 2 -->
                    <div class="flex items-center justify-center w-full">
                        <label for="image_2"
                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6" id="image_2_container">
                                <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                            ...
                            <input id="image_2" type="file" class="hidden" name="image_2" />
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="image_3"
                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6" id="image_3_container">
                                <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                            ...
                            <input id="image_3" type="file" class="hidden" name="image_3" />
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="image_4"
                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6" id="image_4_container">
                                <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                            ...
                            <input id="image_4" type="file" class="hidden" name="image_4" />
                        </label>
                    </div>
                </div>
            </div>
            ...
            <!-- Description -->
            <div class="mb-4">
                <label for="description" class="mb-2.5 block font-medium text-black dark:text-white">Description</label>
                <textarea id="description" name="description" rows="8"
                    class="w-full rounded-lg border border-stroke bg-transparent py-4 px-6 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" /></textarea>
...
@push('iniscripts')
    <script>
        ...
        const map = new mapboxgl.Map({
            ...
            center: [106.8, -6.2], // starting position [lng, lat]
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    imgElement.setAttribute('class',
                        'w-full h-60 object-cover rounded-lg'); // Menambahkan class untuk styling
    ...
    <script>
        function previewImage(event, containerId) {
            const file = event.target.files[0]; // Mengambil file yang dipilih
            const imageContainer = document.getElementById(containerId); // Mengambil div container
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    imgElement.setAttribute('src', e.target
                        .result); // Mengatur atribut src dengan data URL dari file yang dipilih
                    imgElement.setAttribute('class',
                        'w-full h-64 object-cover rounded-lg'); // Menambahkan class untuk styling
