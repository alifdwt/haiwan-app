                        ...
                        <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="text" placeholder="Enter your clinic name" id="name"
                                            name="name"
                                ...
                                <div class="mb-4">
                                    <label for="phone"
                                        class="mb-2.5 block font-medium text-black dark:text-white">Phone</label>
                                    <div class="relative">
                                        <input type="phone" placeholder="Enter your clinic phone number"
                                            id="phone" name="phone"
                                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                                        <span class="absolute right-4 top-4">
                                ...
                                <div class="mb-4 columns-3">
                                    ...
                                    <div>
                                        <label for="state"
                                            class="mb-2.5 font-medium text-black dark:text-white">State</label>
                                    ...
                                    <div>
                                        <label for="city"
                                            class="mb-2.5 font-medium text-black dark:text-white">City</label>
                                    ...
                                    <div>
                                        <label for="zip"
                                            class="mb-2.5 font-medium text-black dark:text-white">Zip</label>
                                ...
                                <div class="mb-4 columns-2">
                                    ...
                                    <div>
                                        <div>
                                            <label for="opening_hours_from"
                                                class="mb-2.5 font-medium text-black dark:text-white">Opening hours
                                                from</label>
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-2">
                                            <div class="flex flex-col gap-3">
                                                <div>
                                                    <input type="checkbox" id="monday" name="opening_days[]"
                                                        value="monday">
                                                    <label for="monday">Monday</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" id="tuesday" name="opening_days[]"
                                                        value="tuesday">
                                                    <label for="tuesday">Tuesday</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" id="wednesday" name="opening_days[]"
                                                        value="wednesday">
                                                    <label for="wednesday">Wednesday</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" id="thursday" name="opening_days[]"
                                                        value="thursday">
                                            ...
                                            <div class="flex flex-col gap-3">
                                                <div>
                                                    <input type="checkbox" id="friday" name="opening_days[]"
                                                        value="friday">
                                                    <label for="friday">Friday</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" id="saturday" name="opening_days[]"
                                                        value="saturday">
                                    ...
                                    <div class="mb-4 columns-3">
                                        ...
                                        <div class="flex items-center justify-center w-full">
                                            <label for="image_2"
                                                ...
                                                <input id="image_2" type="file" class="hidden"
                                                    name="image_2" />
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center justify-center w-full">
                                            <label for="image_3"
                                                ...
                                                <input id="image_3" type="file" class="hidden"
                                                    name="image_3" />
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center justify-center w-full">
                                            <label for="image_4"
                                                ...
                                                <input id="image_4" type="file" class="hidden"
                                                    name="image_4" />
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-4">
                                    <label for="password_confirmation"
                                        class="mb-2.5 block font-medium text-black dark:text-white">Confirm
                                        Password</label>
                                    <div class="relative">
